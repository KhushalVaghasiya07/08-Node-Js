...
const { homepage, addMovie, delMovie, editFormRender, editMovie, addMovieFormRender, bookingViewPageRender } = require("../controller/movie.controller");
...
router.get("/booking/:id", bookingViewPageRender)
